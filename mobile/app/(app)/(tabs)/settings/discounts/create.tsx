// BizAssist_mobile
// path: app/(app)/(tabs)/settings/discounts/create.tsx
//
// Header governance:
// - Create Discount is a PROCESS screen -> use EXIT.
// - Exit cancels and returns deterministically (returnTo or settings discounts ledger).
...
export default function DiscountCreateScreen() {
	...
	}, [canSave, create, noteText, isStackable, name, nameCheck, returnTo, router, safeReplace, type, valueCheck, withBusy]);
