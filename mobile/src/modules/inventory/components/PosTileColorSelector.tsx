// BizAssist_mobile
// path: src/modules/inventory/components/PosTileColorSelector.tsx
...
export const PosTileColorSelector = memo(function PosTileColorSelector({
	label = "Tile color",
	value,
	onChange,
	disabled = false,
	...
	return (
		<View style={styles.root}>
				...
				{items.map((c, idx) => {
					...
					return (
						<Pressable
							...
							accessibilityLabel={isNone ? "No Color" : `Color ${c}`}
						>
							<BAISurface
								padded={false}
								style={[
			...
			<BAIText variant='caption' muted>
				Optional. Used as the fallback color for POS tiles when no image is set.
			</BAIText>
		</View>
	);
});
